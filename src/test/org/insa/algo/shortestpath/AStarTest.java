...
public class AStarTest {
	...
	public void AStarTestPerformance() throws IOException {
		...
		//String mapName = "C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/insa/europe/france/bretagne.mapgr";
		//String pathName = "C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/insa/europe/france/bretagne.path";
		
		//***************Path Ordinateur Morvan map Midi-pyr�n�es*********************/
		//String mapName = "C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/insa/europe/france/midi-pyrenees.mapgr";
		//String pathName = "C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/insa/europe/france/midi-pyrenees.path";
		
		//***************Path Ordinateur Morvan map Belgique*********************/
		//String mapName = "C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/insa/europe/france/belgium.mapgr";
		//String pathName = "C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/insa/europe/france/belgium.path";
	    ...
	    //coordonnées carte midi-pyrénées
	    int idOrigin=114565;
	    int idDest=260540;
		...
		File ff=new File("C:/Users/Katill�r/Documents/INSA/3ir/be_graphes/resultat.txt"); // d�finir l'arborescence
		ff.createNewFile();
		FileWriter ffw=new FileWriter(ff,true);
		
		ffw.write("temps d'�xecution de Dijkstra:"+diffD+"\n");  // �crire une ligne dans le fichier resultat.txt
		ffw.write("temps d'�xecution de Astar:"+diffA+"\n");  // �crire une ligne dans le fichier resultat.txt
		ffw.write("sol: "+SPD+"\n");  // �crire une ligne dans le fichier resultat.txt
		ffw.write("sol: "+SPASS+"\n");  // �crire une ligne dans le fichier resultat.txt
